...
<div class="breadcumb-wrapper " data-bg-src="assets/img/contactban.png">
    <div class="container z-index-common">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title"><?= $lang['franchisepayment'] ?></h1>
            <div class="breadcumb-menu-wrap">
                <ul class="breadcumb-menu">
                    <li><a href="index.php"><?= $lang['home'] ?></a></li>
                    <li><?= $lang['franchisepayment'] ?></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="contact-box">
                            ...
                            <form class="" action="panel/settings/franchise.php" method="POST">
                                <div class="row gx-20">
                                    ...
                                    <div class="col-12 form-group">
                                        <select name="subject" id="subject">
                                            <option selected disabled hidden><?= $lang['subject7'] ?></option>
                                            <option value="<?= $lang['subject4'] ?>"><?= $lang['subject4'] ?></option>
                                            <option value="<?= $lang['subject5'] ?>"><?= $lang['subject5'] ?></option>
                                            <option value="<?= $lang['subject6'] ?>"><?= $lang['subject6'] ?></option>

                                        </select>
                                    </div>

                                    <div class="col-md-6 form-group">
                                        <input type="text" name="address" id="name" placeholder="<?= $lang['address'] ?>">
                                        <i class="fal fa-user"></i>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <input type="email" name="jop" id="email" placeholder="<?= $lang['jop'] ?>">
                                        <i class="fal fa-envelope"></i>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <button type="submit" name="franchise" class="vs-btn"><?= $lang['send'] ?><i class="far fa-arrow-right"></i></button>
                                    </div>
                                </div>
                            </form>
