...
<?php
$info = $config->db->prepare("SELECT * from woocommerce where id=?");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Eticaret Ayaları</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Anasayfa</a></li>
                        <li class="breadcrumb-item active">Eticaret Ayaları</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card  <?php if (isset($_GET['status'])) {
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> <?php if (isset($_GET['status'])) {
                                                        ...
                                                        echo "Eticaret Ayaları";
                                                    }  ?> </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" action="settings/woocommerce-settings.php">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <!-- text input -->
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Kdv Oranı </label>
                                            <input type="text" class="form-control" name="kdv" value="<?= $infoAll['kdv'] ?>" id="exampleInputEmail1" placeholder="Site Başlığı">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Para Birimi</label>
                                            <input type="text" class="form-control" name="price_type" value="<?= $infoAll['price_type'] ?>" id="exampleInputEmail1" placeholder="Site Açıklaması">
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="row">
                                ...
                                <div class="card-footer">
                                    <button style="width: 100%;" type="submit" name="update_woocommerce_setting" class="btn btn-primary ">Kaydet</button>
                                </div>
